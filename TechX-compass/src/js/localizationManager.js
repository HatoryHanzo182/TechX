...
export const changeLanguage = async (language, list_item) => {
  ...
  document
    .querySelectorAll(".products-card")[2]
    .querySelector("h2").textContent =
  ...
  ).textContent = localization["settings"]["language_select_label"];
