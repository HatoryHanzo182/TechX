...
const create_products_content = document.getElementById(
  "id-create-product-content",
);
/*========================================*/
...
document
  .getElementById("id-create-product")
  .addEventListener("click", ShowContentProductCreation);
/*========================================*/

/*========== Logic for exiting the admin panel sector.==========*/
function ClickExitAccount() {
  electron.send("ShowAuthorization");
}
...
document
  .getElementById("id-exit-exit")
  .addEventListener("click", ClickExitAccount);
document
  .getElementById("id-cancel-exit")
  .addEventListener("click", ClickCancelAccount);
/*========================================*/
