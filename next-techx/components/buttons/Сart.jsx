...
import { LucideShoppingCart, ShoppingBagIcon, ShoppingBasket, ShoppingCart } from "lucide-react";
            ...
            <ScrollArea className="h-96 w-full ">
              ...
              (
                <div key={ index } className="grid grid-cols-4 items-center gap-4 mt-3">
                  <div>
                    <img src={`http://localhost:3001/GetImage/${item.img}`} alt="img" className="w-10" />
                  </div>
                  <div>{item.model}</div>
                  <div>{item.price}$</div>
                  <div>
